...
import './App.css';
import WorkExperienceTable from './WorkExp';
// import ChooseAddress from './ChooseAdress';
// import AddressForm from './AdressForm';
// import Adress from './Address';
import MyComponent from './Address2';
import FamilyRelationshipTable from './FamilyRelationships';
import SalaryHistoryTable from './SalaryHistory';
...
const SYLL = () => {
  ...
  const [rows, setRows] = useState([{ tenTruong: '', chuyenNganh: '', thoiGian: '', hinhThucDaoTao: '', vanBang: '' }]);
  ...
  const addRow = () => {
    setRows([...rows, { tenTruong: '', chuyenNganh: '', thoiGian: '', hinhThucDaoTao: '', vanBang: '' }]);
  };
    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          ...
          />
          Giới tính:
          <select name="gioiTinh" value={formValues.gioiTinh} onChange={handleChange}>
      ...
      /> */}
        ...
        <label>
          9. Nơi ở hiện nay:
          <MyComponent onAddressChange={handleAddressChange(address4, setAddress4)} />
          <input
            type="text"
            value={address4}
            onChange={(e) => setAddress3(e.target.value)}
        ...
        <label>
          14. Ngạch công chức:
          Mã ngạch, Bậc lương, Hệ số, Ngày hưởng, Phụ cấp chức vụ, Phụ cấp khác
          <input
            type="text"
            name="ngachCongChuc"
        ...
        <label>
          ...
          <select name="trinhDoChuyenMonCaoNhat" value={formValues.trinhDoChuyenMonCaoNhat} onChange={handleChange}>
        ...
        <label>
          ...
          <div>
          <WorkExperienceTable onUpdateWorkExperiences={updateWorkExperiences} />
          </div>
        </label> <br />
        <label>
        ...
        <FamilyRelationshipTable onUpdateFamilyRelationships={updateFamilyRelationships1} />
        </label> <br/>

        <label>
        a) Về bên vợ (hoặc chồng): Cha, Mẹ, anh chị em ruột
          <FamilyRelationshipTable onUpdateFamilyRelationships={updateFamilyRelationships2} />
        </label> <br/>
        ...
        <button style={{margin:'100px 40px 10px 1000px',position:'absolute',top:'0' /* Đặt nút ở trên cùng */}} className="submit-button" type="submit">Gửi</button>
      </form>
    </div>
  );
};
